...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=localhost\\SQLEXPRESS;Database=AdventureWorks2016CTP3;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustomerPii>(entity =>
            {
                ...
                entity.ToTable("CustomerPII", "Sales");
            ...
            modelBuilder.Entity<OrderTracking>(entity =>
            {
                ...
                entity.HasComment("Individual tracking events associated with a specific sales order.");
                ...
                entity.Property(e => e.EventDateTime).HasComment("The date and time that a tracking event has occurred.");

                entity.Property(e => e.EventDetails)
                    .IsRequired()
                    .HasMaxLength(2000)
                    .HasComment("Details for a delivery tracking event.");

                entity.Property(e => e.SalesOrderId)
                    .HasColumnName("SalesOrderID")
                    .HasComment("Sales order identification number.  Foreign key to SalesOrderHeader.SalesOrderID.");

                entity.Property(e => e.TrackingEventId)
                    .HasColumnName("TrackingEventID")
                    .HasComment("Tracking delivery event for Order shipped to customer. Foreign key to TrackingEvent.TrackingEventID.");
            });
            ...
            modelBuilder.Entity<TrackingEvent>(entity =>
            {
                ...
                entity.HasComment("Tracking event lookup table.");
                ...
                entity.Property(e => e.EventName)
                    .IsRequired()
                    .HasMaxLength(255)
                    .HasComment("Tracking event name.");
            });
            ...
            modelBuilder.Entity<VEmployeePersonTemporalInfo>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vEmployeePersonTemporalInfo", "HumanResources");
